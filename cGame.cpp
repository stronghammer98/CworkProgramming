...
void cGame::initialise(SDL_Window* theSDLWND, SDL_Renderer* theRenderer)
{
	...
	// Store the textures
	textureName = { "ufo1", "ufo2", "bullet","theRocket","theBackground"};
	texturesToUse = { "Images\\ufo1.png", "Images\\ufo2.png", "Images\\bullet.png", "Images\\rocketSprite.png", "Images\\cartoonsky.png"};
	...
	for (int astro = 0; astro < 5; astro++)
	{
		...
		theAsteroids[astro]->setSpritePos({ 650, 50 * (rand() % 10 + 1) });
		...
		theAsteroids[astro]->setAsteroidVelocity({ 200, 20 });
